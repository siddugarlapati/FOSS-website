      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="mb-24">
          ...
          <h2 className="text-5xl md:text-8xl font-black text-white mb-8 tracking-tighter">
            Student <br /> <span className="text-emerald-400">Power Tools.</span>
          </h2>
          <p className="text-neutral-500 text-xl md:text-2xl max-w-3xl leading-relaxed">
            We don't just host code; we curate the roadmap. These are the repositories that 
            build world-class engineers. Start your journey here.
          </p>
        </div>
